...
public class ReviewSortAdapter extends RecyclerView.Adapter<ReviewSortAdapter.MyViewHolder> {
    ...
    public ReviewSortAdapter(Context context, List<Cafe> list) {       // 생성자
    ...
    @NonNull
    @Override
    public ReviewSortAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.cafe_item, parent, false);
        return new ReviewSortAdapter.MyViewHolder(itemView);
    }
